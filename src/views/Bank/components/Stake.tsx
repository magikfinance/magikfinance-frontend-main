...
const Stake: React.FC<StakeProps> = ({ bank }) => {
  ...
  const multiplier = (bank.depositTokenName.includes('MAGIK') || bank.depositTokenName.includes('MSHARE-USDC-LP'))  && !bank.depositTokenName.includes('WLRS-USDIBS-LP') && !bank.depositTokenName.includes('XWLRS') ? 10**6 : 1;
