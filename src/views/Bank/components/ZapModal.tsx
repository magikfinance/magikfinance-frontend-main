  ...
  return (
    <Modal>
      ...
      >
        ...
        <StyledMenuItem value={TSHARE_TICKER}>MSHARE</StyledMenuItem>
        {/* Magik as an input for zapping will be disabled due to issues occuring with the Gatekeeper system */}
        {/* <StyledMenuItem value={TOMB_TICKER}>MAGIK</StyledMenuItem> */}
      </Select>
      <TokenInput
