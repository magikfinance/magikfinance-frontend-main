...
import ERC20 from '../magik-finance/ERC20';
...
function useApproveTaxOffice(): [ApprovalState, () => Promise<void>] {
  ...
  let token: ERC20 = tombFinance.MAGIK;
  // if (zappingToken === FTM_TICKER) token = tombFinance.FTM;
  // else if (zappingToken === TOMB_TICKER) token = tombFinance.MAGIK;
  // else if (zappingToken === TSHARE_TICKER) token = tombFinance.MSHARE;
