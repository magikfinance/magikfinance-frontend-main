...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  MagikFTMMagikStake: {
    name: 'Earn MAGIK by MAGIK-FTM LP',
    poolId: 0,
    sectionInUI: 5,
    contract: 'MagikFTMMagikStake',
  ...
  MagikUSDCMagikStake: {
    name: 'Earn MAGIK by MAGIK-USDC LP',
    poolId: 1,
    sectionInUI: 5,
    contract: 'MagikUSDCMagikStake',
  ...
  MshareUSDCMagikStake: {
    name: 'Earn MAGIK by MSHARE-USDC LP',
    poolId: 2,
    sectionInUI: 5,
    contract: 'MshareUSDCMagikStake',
