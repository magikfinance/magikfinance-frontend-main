...
const configurations: { [env: string]: Configuration } = {
  development: {
    ...
    externalTokens: {
      ...
      'USDT-FTM-LP': ['0xBB298171BE6AdD24b228f2B5A9D597f1bF354ABC', 18],
      'MAGIK-FTM-LP': ['0xdc71a6160322ad78dab0abb47c7a581cfe9709ee', 18],
      'MAGIK-FTM-MS': ['0xA4188C6ec7CeCDdC0D975c79E0430786fF6eDD07', 18],
      ...
      'MAGIK-MSHARE-LP-MS': ['0x451A339E0b122edDa68F750e5b1458Ec2b0935f7', 18],
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  MSMagikFtmLPReward: {
    name: 'Earn MSHARE by MAGIK-FTM-MS',
    poolId: 19,
    sectionInUI: 2,
    contract: 'MSMagikFtmLPReward',
    depositTokenName: 'MAGIK-FTM-MS',
    earnTokenName: 'MSHARE',
    finished: false,
    sort: 10,
    closedForStaking: false,
  ...
  MshareFtmMSLP: {
    ...
    MagikMshareMSLP: {
    name: 'Earn MSHARE by MAGIK-MSHARE-LP-MS',
    poolId: 17,
    sectionInUI: 2,
    contract: 'MagikMshareMSLP',
    depositTokenName: 'MAGIK-MSHARE-LP-MS',
    earnTokenName: 'MSHARE',
    finished: false,
    sort: 10,
    closedForStaking: false,
