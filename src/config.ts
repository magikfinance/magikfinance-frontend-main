...
const configurations: { [env: string]: Configuration } = {
  development: {
    ...
    externalTokens: {
      ...
      'MAGIK-FTM-LP RED': ['0xdA52C116fB258dC286CEbAB47bC5169597206574', 18],
      'MSHARE-FTM-LP RED': ['0x7a1CeE76D132f12e534613De2AA0ec361504a659', 18],
...
export const bankDefinitions: { [contractName: string]: BankInfo } = {
  ...
  */
  ...
  MagikRedLPReward: {
    name: 'Earn MSHARE by MAGIK-FTM-LP RED',
    poolId: 4,
    sectionInUI: 2,
    contract: 'MagikRedLPReward',
    depositTokenName: 'MAGIK-FTM-LP RED',
    earnTokenName: 'MSHARE',
    finished: false,
    sort: 10,
  ...
  MshareRedLPReward: {
    ...
    depositTokenName: 'MSHARE-FTM-LP RED',
    earnTokenName: 'MSHARE',
    finished: false,
    sort: 10,
    closedForStaking: true,
