...
const MigrationDisclaimerModal: React.FC<MigrationDisclaimerModalProps> = ({ onConfirm, onDismiss }) => {
  ...
  return (
    <Modal>
      ...
      <div>
        <StyledText>
          Due to the upgrade, all Dungeon functionalities other than [Settle and withdraw] has been disabled for users
          who staked in legacy Dungeon. Please withdraw all balances from the previous dungeon after the update.
        </StyledText>
      </div>
      <ModalActions>
